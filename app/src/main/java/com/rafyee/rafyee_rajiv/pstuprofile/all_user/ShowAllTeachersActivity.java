...
public class ShowAllTeachersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_all_teachers_activity);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(ShowAllTeachersActivity.this, MainActivity.class);
        ...
        /* AGRICULTURE ADAPTER */
        final ArrayAdapter AGRICULTURE_Adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.agriculture, android.R.layout.simple_spinner_dropdown_item);
        ...
        /* CSE ADAPTER */
        final ArrayAdapter CSE_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.CSE, android.R.layout.simple_spinner_dropdown_item);
        CSE_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(CSE_adapter);

        /* BBA ADAPTER */
        final ArrayAdapter BBA_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.bba, android.R.layout.simple_spinner_dropdown_item);
        BBA_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(BBA_adapter);

        /* FISHARIES ADAPTER */
        final ArrayAdapter FISHARIES_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.fisharies, android.R.layout.simple_spinner_dropdown_item);
        FISHARIES_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(FISHARIES_adapter);

        /* LAND ADAPTER */
        final ArrayAdapter LAND_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.land_management, android.R.layout.simple_spinner_dropdown_item);
        LAND_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(LAND_adapter);

        /* NFS ADAPTER */
        final ArrayAdapter NFS_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.nfs, android.R.layout.simple_spinner_dropdown_item);
        NFS_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(NFS_adapter);

        /* DISASTER ADAPTER */
        final ArrayAdapter DISASTER_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.disaster_management, android.R.layout.simple_spinner_dropdown_item);
        DISASTER_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        //dept.setAdapter(DISASTER_adapter);

        /* DVM & ANIMAL ADAPTER */
        final ArrayAdapter DVM_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.dvm, android.R.layout.simple_spinner_dropdown_item);
        DVM_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);

        /* FACULTY */
        ArrayAdapter Faculty_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.facultys, android.R.layout.simple_spinner_dropdown_item);
        ...
        teacherFaculty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(ShowAllTeachersActivity.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });

        /*------------------DEPARTSMENTS-------------------*/
        ArrayAdapter Department_adapter = ArrayAdapter.createFromResource(ShowAllTeachersActivity.this, R.array.departments, android.R.layout.simple_spinner_dropdown_item);
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.Show_Teacher,
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonArray.length() == 0) {
                                        Toast.makeText(ShowAllTeachersActivity.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                                    } else {
                                ...
                                teacherAdapter = new TeacherAdapter(ShowAllTeachersActivity.this, teacherUnitList);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(ShowAllTeachersActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
                    @Override
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(ShowAllTeachersActivity.this);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ShowAllTeachersActivity.this, TeacherPersonalDetailsActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ShowAllTeachersActivity.this, MainActivity.class);
        startActivity(intent);
        finish();
        overridePendingTransition(R.anim.slide_from_right, R.anim.slideout_from_left);
        super.onBackPressed();
