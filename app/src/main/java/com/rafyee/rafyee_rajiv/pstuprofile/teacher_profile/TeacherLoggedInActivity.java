...
public class TeacherLoggedInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_logged_in_activity);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.Teacher_Login_Personal_Details,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonArray.length() == 0) {
                                Toast.makeText(TeacherLoggedInActivity.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                            } else {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TeacherLoggedInActivity.this, "Login failed", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TeacherLoggedInActivity.this);
        requestQueue.add(stringRequest);

        goToTeacherUpdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(TeacherLoggedInActivity.this, TeacherLoggedInPersonalUpdateActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TeacherLoggedInActivity.this, MainActivity.class);
