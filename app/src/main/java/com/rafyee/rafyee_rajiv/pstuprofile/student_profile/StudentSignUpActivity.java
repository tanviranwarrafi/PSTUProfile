...
public class StudentSignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentFaculty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(StudentSignUpActivity.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void signUpStudent() {
        if (studentName.getText().toString().equals("") &&
            ...
            Toast.makeText(StudentSignUpActivity.this, "অনুগ্রহ পূর্বক সব তথ্য পূরণ করুন", Toast.LENGTH_SHORT).show();
        } else {
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(StudentSignUpActivity.this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.Student_Registration,
                ...
                public void onErrorResponse(VolleyError error) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(StudentSignUpActivity.this, "সাইন আপ ব্যর্থ হয়েছে। অনুগ্রহ পূর্বক সব তথ্য পূরণ করুন", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
