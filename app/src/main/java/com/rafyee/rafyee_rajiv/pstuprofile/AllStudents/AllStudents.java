...
public class AllStudents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(AllStudents.this, MainActivity.class);
        ...
        /* FACULTY SPINNER */
        ArrayAdapter Faculty_adapter = ArrayAdapter.createFromResource(AllStudents.this, R.array.facultys, android.R.layout.simple_spinner_dropdown_item);
        ...
        studentFaculty.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(AllStudents.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });

        /* BATCH SPINNER */
        ArrayAdapter BATCH_adapter = ArrayAdapter.createFromResource(AllStudents.this, R.array.batchs, android.R.layout.simple_spinner_dropdown_item);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(AllStudents.this, StudentDetails.class);
    ...
    private void showAllStudent() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.All_Students,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        studentAdapter = new StudentAdapter(AllStudents.this, studentUnitList);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AllStudents.this);
