...
//    private CheckBox showPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teacherRegistration.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TeacherLoginActivity.this, TeachersSignUpActivity.class);
    ...
    private void teacherLogin() {
        if (teacherEmail.getText().toString().equals("") &&
            ...
            if (teacherEmail.getText().toString().matches(emailPattern)){
                ...
                RequestQueue queue = Volley.newRequestQueue(TeacherLoginActivity.this);
                ...
                StringRequest postRequest = new StringRequest(Request.Method.POST, Config.Teacher_Login,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                if (response.equals("Success")) {
                                    Intent intent = new Intent(TeacherLoginActivity.this, TeacherLoggedInActivity.class);
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                progressBar.setVisibility(View.GONE);
                                Toast.makeText(TeacherLoginActivity.this, "লগইন ব্যর্থ হয়েছে। আবার চেষ্টা করুন", Toast.LENGTH_SHORT).show();
                            }
                        }
                ) {
                    @Override
