...
public class CourseDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cources_details_activity);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(CourseDetailsActivity.this, ShowCourseFacultyActivity.class);
        ...
        ArrayAdapter Semester_adapter = ArrayAdapter.createFromResource(CourseDetailsActivity.this, R.array.semesters, android.R.layout.simple_spinner_dropdown_item);
        ...
        semesterSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(CourseDetailsActivity.this, "Please Select One...", Toast.LENGTH_SHORT).show();
            }
        });
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.User_Show_Course,
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonArray.length() == 0) {
                                        Toast.makeText(CourseDetailsActivity.this, "No Data Recorded", Toast.LENGTH_SHORT).show();
                                    } else {
                                ...
                                courseAdapter = new CourseAdapter(CourseDetailsActivity.this, courseUnits);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressBar.setVisibility(View.GONE);
                        Toast.makeText(CourseDetailsActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(CourseDetailsActivity.this, ShowCourseFacultyActivity.class);
