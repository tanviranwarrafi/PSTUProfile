...
public class TeacherPersonalDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_personal_details_activity);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent = new Intent(TeacherPersonalDetailsActivity.this, ShowAllTeachersActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TeacherPersonalDetailsActivity.this, ShowAllTeachersActivity.class);
